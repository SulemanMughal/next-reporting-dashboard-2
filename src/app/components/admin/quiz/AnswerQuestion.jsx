...
export default function AnswerQuestion({question, obtained_points , submitAnswer}){
    return (
        <>
...
<div className="w-full text-gray-900 bg-white border-none rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white my-4">
...
{[...Array(6)].map((item, index) => (
    <>
        {question["option_" + (index+1)] !== "" ?  (
            <button type="button" 
                className={"relative inline-flex items-center w-full px-4 py-2 text-lg font-medium border border-gray-200 rounded-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:border-gray-600 dark:hover:bg-gray-600 dark:hover:text-white dark:focus:ring-gray-500 dark:focus:text-white my-1"}
                >
            {submitAnswer.trim() ===  (index+1).toString() ? (
