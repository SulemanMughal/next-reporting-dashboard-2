...
function SubmitBtn({isSubmit,setUpdateQuestion , setRemoveQuestion , setQuestion , question}){
        ...
        <>
            {isSubmit ? <button disabled type="button" className="py-2.5 px-5 mr-2 text-sm font-medium text-gray-900 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700  inline-flex items-center w-full justify-center">
                ...
                <button
                    ...
                    type="button"
                    onClick={() => (setRemoveQuestion(true) , setQuestion(question) , setUpdateQuestion(false) )}  
                > <IoMdRemoveCircle  size={23} className="mr-2" /> <span>Remove Question</span> </button>
...
export default function UpdateQuizQuestion({question , setUpdateQuestion , setData , quizId , setQuestion , setRemoveQuestion}){
        ...
        <>        
            ...
            <div className="relative w-2/5 px-4 space-y-16 ">
                ...
                <div className="flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t">
                    ...
                    onClick={() => (setUpdateQuestion(false), setQuestion(null))}
                ...
                <div className="relative p-6 flex-auto">
                    <form className="space-y-6" onSubmit={submitHandler} >
                        ...
                        {/* scenario field */}
                        <div className="relative z-0 w-full mb-6 group">
                            <select id="scenario" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  focus:outline-none focus:ring-0 focus:border-blue-600 peer " value={scenario_id.current}  onChange={(e) => scenario_id.current = e.target.value}>
                        ...
                        <SubmitBtn  isSubmit={isSubmit} setQuestion={setQuestion} setUpdateQuestion={setUpdateQuestion}  setRemoveQuestion={setRemoveQuestion}  question={question}/>
                    </form>
