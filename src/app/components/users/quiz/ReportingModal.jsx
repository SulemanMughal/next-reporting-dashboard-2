...
module.exports = ({
    ...
    return <>
        ...
        <Transition show={isOpen}>
            ...
            >
                <div style={{ zIndex: '2' }} className="flex w-full  top-1/3   fixed">
                    <div className="inline-block w-full align-bottom bg-dark-imperial-blue rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:w-full sm:max-w-md ">
                        {/* <div className="w-full flex justify-between items-center p-4  " style={{ "border": "0.2rem solid #2b344c !important"}}>
                        ...
                        <div>
                            <label htmlFor="team-description-input" className="text-sm text-gray-300 font-sans
                            
                            ">Description</label>
                            <textarea id="team-description-input" className="input w-full block mt-1" ></textarea>
                        </div>
