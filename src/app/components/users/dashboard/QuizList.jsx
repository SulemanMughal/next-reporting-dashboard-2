...
export default function QuizList(){
    return (
        ...
        <>
            {
                [...Array(5)].map((e, index) => (
                    <div className="w-full col-span-3 relative  p-3   rounded-lg h-full " key={index}>
                <div className="  my-2 bg-card-custom  rounded-lg shadow   ">
                    ...
                    <div className=" pt-4 pb-2 flex justify-center">
                        <Link href={`/user/quiz/123`}  className="transition ease-in-out delay-150 hover:-translate-y-1    hover:bg-blue-300 hover:text-blue-800 cursor-pointer duration-300    theme-bg-color text-gray-300  flex items-center  w-7/12 h-full rounded-0 px-4 py-2 text-xl font-semibold  mr-2 mb-2 justify-center items-center  ">
